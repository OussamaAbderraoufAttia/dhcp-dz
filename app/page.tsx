  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Clients & Partners</h2>
            <div className="w-20 h-1 bg-blue-600 mx-auto mb-8"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg text-gray-900">Office Location</h4>
                    <p className="text-gray-600">ESI, Oued Smar, Alger, Algeria</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">lo_attia@esi.dz</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-blue-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+2135 557 555 613</p>
                  </div>
                </div>
